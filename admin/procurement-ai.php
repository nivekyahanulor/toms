...
?>
	 ...
	 <div class="col-7">
		    <div class="card">
				  ...
				  <button class="btn btn-info btn-md" type="button" onclick="printDiv('printableArea')"/><i class="fas fa-print"></i> Print </button>
					...
					$brgy1  = $_GET['brgy']; 
					/** GET PR INFO **/
					$pr	   = $mysqli->query("SELECT * FROM ai_report where brgy_id='$brgy1' and pro_id='$proid'");
					...
					?>
					 <?php if($prres['is_approved'] == 1){ echo " <center> <b> ACCEPTANCE AND INSPECTION REPORT APPROVED  </b></center>  " ; } 
					else if($prres['is_approved'] == 2){ echo " <center> <b>ACCEPTANCE AND INSPECTION REPORT DECLINED </b></center> " ; } 
					else{ ?>
	...
	<div class="modal fade" id="approved" tabindex="-1" role="dialog"  aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalCenterTitle">ACCEPTANCE AND INSPECTION REPORT</h5>
								...
								<div class="modal-footer bg-whitesmoke br">
									<button type="submit" class="btn btn-success" name="process-approved-ai">Approved</button>
						...
						<div class="modal fade" id="declined" tabindex="-1" role="dialog"  aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								<div class="modal-footer bg-whitesmoke br">
									<button type="submit" class="btn btn-warning" name="process-decline-ai">Declined</button>
									<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
								</div>
								</form>
								</div>
