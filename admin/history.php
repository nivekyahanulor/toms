                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-bordered" id="covid-data">
						...
						<?php while($val = $history->fetch_object()){ ?>
							<tr> 
								<td class="text-left"> <?php echo $val->user;?> </td>
								<td class="text-left"> <?php echo $val->actions ;?> </td>
								<td class="text-center"> <?php echo date ('Y-m-d', strtotime($val->date_recorded));?> </td>
								<td class="text-center"> <?php echo date ('H:i:s', strtotime($val->date_recorded));?> </td>
							</tr>
