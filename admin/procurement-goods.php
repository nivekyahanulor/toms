										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card5;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-pa-receipt.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color4;?>">PA Receipt</span></a>
													<?php } else { ?>
