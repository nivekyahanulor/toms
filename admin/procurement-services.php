                  ...
                  <div class="card-body">
					...
					<?php if(isset($_GET['process-done'])){ echo '<div class="alert alert-success">Process Successfully Done!</div>';}?>
                      <table class="table table-striped table-bordered" id="sk-data">
						...
						<tbody>
						<?php 
							$goods	= $mysqli->query("SELECT * FROM sk_procurement where brgy_id='$data' and procurement_type=2");
										...
										<div class="row">
											...
											<div class="card <?php echo $card1;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-purchase-request.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color;?>">Purchase Request</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card  <?php echo $card2;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-bac-resolution.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color1;?>">BAC Resolution</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card3;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-qoutation.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color2;?>">Quotation</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card3;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-abstract-qoutation.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color2;?>">Abstract Of Quotation</span></a>
													<?php } else { ?>
									   ...
									   <div class="row">
											...
											<div class="card <?php echo $card4;?>">
											  <div class="card-body text-center">
													...
													<div style="height:20px;"></div>
													<?php if($count3 !=0){?>
													<?php if($row3['is_approved'] ==1){ $color3 = 'primary';
														  } else if($row3['is_approved'] ==2){ $color3 = 'warning';
														  } else { $color3 = 'success'; }
													?>
													<a href="procurement-purchase-order.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color3;?>">Purchase Order</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card6;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-ai.php?data=<?php echo urlencode(base64_encode($val->proID));?>&brgy=<?php echo $data;?>" target="_blank"><span class="badge badge-<?php echo $color5;?>">Acceptance and Inspection</span></a>
													<?php } else { ?>
				...
				<form  method="post">
					<div class="form-row">
						...
						<div class="input-group">
							...
							<input type="hidden" class="form-control" name="ptype" value="2" required>
						</div>
						</div> 
						<div class="form-group col-md-12">
							<label>Nature  : </label>
