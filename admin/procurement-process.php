									...
									<div class="row ">
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="text" required="required" value="<?php if(isset($_GET['po_supplier1'])){  echo $_GET['po_supplier1']; } else { echo $row3['supplier']; }?>" class="form-control" id="po_supplier"   />
												<input type="hidden" required="required" class="form-control" id="pro_id" value="<?php echo $_GET['data'];?>"  />
												<input type="hidden" required="required" class="form-control" id="p_type" value="<?php echo $_GET['type'];?>"  />
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="text" required="required" value="<?php if(isset($_GET['po_address1'])){  echo $_GET['po_address1']; } else { echo $row3['address']; }?>" id="po_address" class="form-control" />
											</div>
										</div>
									</div>
									<div class="row ">
