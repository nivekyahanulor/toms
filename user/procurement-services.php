						...
						<?php 
							...
							<tr> 
								...
								<td class="text-center"> 
									...
									<a href="procurement-process.php?type=PROCUREMENT OF SERVICES&data=<?php echo $val->proID;?>"><button class="btn btn-success"><i class="fas fa-file"></i></button></a>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card  <?php echo $card2;?>">
											  <div class="card-body text-center">
													...
													<div style="height:20px;"></div>
													<?php if($count1 !=0){?>
													<?php if($row1['is_approved'] ==1){ $color2 = 'primary';
														  } else if($row1['is_approved'] ==2){ $color2 = 'warning';
														  } else { $color2 = 'success'; }
													?>
													<a href="procurement-bac-resolution.php?data=<?php echo urlencode(base64_encode($val->proID));?>" target="_blank"><span class="badge badge-<?php echo $color2;?>">BAC Resolution</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card3;?>">
											  <div class="card-body text-center">
													...
													<div style="height:20px;"></div>
													<?php if($count2 !=0){?>
													<?php if($row2['is_approved'] ==1){ $color3 = 'primary';
														  } else if($row2['is_approved'] ==2){ $color3 = 'warning';
														  } else { $color3 = 'success'; }
													?>
													<a href="procurement-qoutation.php?data=<?php echo urlencode(base64_encode($val->proID));?>" target="_blank"><span class="badge badge-<?php echo $color3;?>">Quotation</span></a>
													<?php } else { ?>
										  ...
										  <div class="col-12 col-md-6 col-lg-3">
											<div class="card <?php echo $card3;?>">
											  <div class="card-body text-center">
													...
													?>
													<a href="procurement-abstract-qoutation.php?data=<?php echo urlencode(base64_encode($val->proID));?>" target="_blank"><span class="badge badge-<?php echo $color3;?>">Abstract Of Quotation</span></a>
													<?php } else { ?>
									   ...
									   <div class="row">
											...
											<div class="card <?php echo $card4;?>">
											  <div class="card-body text-center">
													...
													<div style="height:20px;"></div>
													<?php if($count3 !=0){?>
													<?php if($row3['is_approved'] ==1){ $color4 = 'primary';
														  } else if($row3['is_approved'] ==2){ $color4 = 'warning';
														  } else { $color4 = 'success'; }
													?>
													<a href="procurement-purchase-order.php?data=<?php echo urlencode(base64_encode($val->proID));?>" target="_blank"><span class="badge badge-<?php echo $color4;?>">Purchase Order</span></a>
													<?php } else { ?>
